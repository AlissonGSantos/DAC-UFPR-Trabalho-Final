...
router.patch("/voos/:id/estado", verifyJWT(["CLIENTE", "FUNCIONARIO"]), vooController.updateVooEstado);
...
router.get("/reservas/:id", verifyJWT(["CLIENTE", "FUNCIONARIO"]), reservaController.getReservaById);
